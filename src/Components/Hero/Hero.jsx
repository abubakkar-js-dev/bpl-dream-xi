...
const Hero = () => {
    return (
        <div className='w-11/12 md:container mx-auto flex flex-col justify-center items-center hero-bg h-[545px] rounded-3xl space-y-6 mb-12 md:mb-[88px]'>
           ...
           <button className='btn text-base text-black font-bold bg-primary hover:bg-primary/80 outline outline-1 outline-primary outline-offset-4 rounded-xl px-5 py-[12px]'>Claim Free Credit</button>
        </div>
    );
};
